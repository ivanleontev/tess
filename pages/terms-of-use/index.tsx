...
const termsOffUse = () => {
  return (
    <Row>
      <Col span={4}></Col>
      <Col span={16} style={{ margin: '112px 0px' }}>
        <div className="col">
          <div id="inputResult">
            ...
            <div className="row mb-4">
              <div className="col">
                ...
                <div className="descr">
                  ...
                  <span className="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">
                    asdasdasdasd
                  </span>{' '}
                  (далее&nbsp;— Оператор).
                </div>
                <div className="ol">
                  ...
                  <div className="li">
                    ...
                    веб-сайта{' '}
                    <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">
                      https://asdasdasd
                    </span>
                    .
                  </div>
              ...
              <div className="col">
                ...
                <div className="ol">
                  ...
                  <div className="li">
                    ...
                    персональных данных и&nbsp;обеспечивающих их&nbsp;обработку информационных технологий
              ...
              <div className="col">
                ...
                <div className="ol">
                  ...
                  <div className="li">
                    ...
                    случаев, предусмотренных федеральными законами. Сведения предоставляются субъекту персональных
                  ...
                  <div className="li">—&nbsp;предоставлять Оператору достоверные данные о&nbsp;себе;</div>
                  <div className="li">
            ...
            <div className="row mb-4">
              <div className="col">
                ...
                <div className="ol">
                  <div className="li" id="1441X6NcB">
                    <table className="purpose-table" border={1}>
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td className="data-field">
                            <ul>
                              <li>
                                <span className="mark link">фамилия, имя, отчество</span>
                              </li>
                              <li>
                                <span className="mark link">электронный адрес</span>
                              </li>
                              <li>
                                <span className="mark link">номера телефонов</span>
                              </li>
                              <li>
                        ...
                        <tr>
                          ...
                          <td className="legal-field">
                            <ul>
                              <li>
                                <span className="mark link">уставные (учредительные) документы Оператора</span>
                              </li>
                              <li>
                                <span className="mark link">
                    ...
                    <div className="li">
                      <table className="purpose-table" border={1}>
                        <tbody>
                          <tr>
                            <th>Цель обработки</th>
                            <td className="purpose-field"></td>
                          </tr>
                          <tr>
                            <th>Персональные данные</th>
                            <td className="data-field"></td>
                          </tr>
                          <tr>
                            <th>Правовые основания</th>
                            <td className="legal-field"></td>
                          </tr>
                          <tr>
                            <th>Виды обработки персональных данных</th>
                            <td className="types-field"></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
              ...
              <div className="col">
                ...
                <div className="ol">
                  ...
                  <div className="li">
                    ...
                    <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">
                      asdasdasdasd
                    </span>
                  ...
                  <div className="li">
                    ...
                    не&nbsp;несет ответственность за&nbsp;действия третьих лиц, в&nbsp;том числе указанных
                  ...
                  <div className="li">
                    ...
                    субъектом персональных данных или требование о&nbsp;прекращении обработки персональных данных,
